/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bb98e3b543de440bc1a04175edc2be2c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TTS_API_URL: "https://adhi-thirumala--peter-griffin-chatterbox-speak.modal.run/";
		VIDEO_COMPOSITOR_URL: "https://adhi-thirumala--learnscrolling-compositor-composite-video.modal.run";
		REEL_WORKFLOW: Workflow<Parameters<import("./worker/index").ReelGenerationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLM_API_URL" | "LLM_MODEL" | "TTS_API_URL" | "VIDEO_COMPOSITOR_URL">> {}
}
